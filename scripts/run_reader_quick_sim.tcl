...
set build_dir [file join $build_root reader_quick_sim]
file mkdir $build_dir

create_project -force traffic_replay_reader_quick $build_dir -part xcu200-fsgd2104-2-e
...
set_property verilog_define {READER_QUICK_SIM} [get_filesets sim_1]
